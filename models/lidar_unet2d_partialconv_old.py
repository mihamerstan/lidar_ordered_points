...
class UNet(nn.Module):
	...
	def add_args(parser):
		...
		parser.add_argument("--out_channels",default=1, help="number of output dimensions")
		parser.add_argument("--batch_norm",default=True, help="Whether or not to use batchnorm layers")
	@classmethod
	def build_model(cls, args):
		return cls(bias=args.bias, in_channels=args.in_channels, out_channels=args.out_channels, residual_connection=args.residual)
