...
class DnCNN(nn.Module):
	def __init__(self, depth=20, n_channels=64, image_channels=1, use_bnorm=True, kernel_size=3):
		...
		self.first_layer = PartialConv1d.PartialConv1d(in_channels=image_channels, out_channels=n_channels, kernel_size=kernel_size, stride=1, padding=padding, bias=False, multi_channel=False, return_mask=True)
		...
		for i in range(self.depth-2):
			...
			self.hidden_layer_list[i] = PartialConv1d.PartialConv1d(in_channels=n_channels, out_channels=n_channels, kernel_size=kernel_size, stride=1, padding=padding, bias=False, multi_channel=False, return_mask=True)
		...
		self.last_layer = PartialConv1d.PartialConv1d(in_channels=n_channels, out_channels=image_channels, kernel_size=kernel_size, stride=1, padding=padding, bias=False, multi_channel=False, return_mask=True)
...
class intermediate_out_DnCNN(nn.Module):
	def __init__(self, depth=20, n_channels=64, image_channels=1, use_bnorm=True, kernel_size=3):
		super(intermediate_out_DnCNN, self).__init__()
		kernel_size = 3
		padding = 1
